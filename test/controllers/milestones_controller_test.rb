...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { name: @milestone.name, task_id: @milestone.task_id } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { name: @milestone.name, task_id: @milestone.task_id } }
